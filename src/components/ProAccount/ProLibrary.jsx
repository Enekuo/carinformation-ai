          ...
          <div className="rounded-2xl bg-white ring-1 ring-slate-200 shadow-sm p-8">
            ...
            {(type === "all" ||
              ...
              <div className="flex flex-wrap gap-[38px]">
                ...
                {/* ===== PLANTILLAS VISIBLES (solo en ALL / Denak) ===== */}
                {type === "all" && (
                  <>
                    {/* Paraphraser */}
                    <div
                    ...
                    >
                      <div className="h-full w-full px-5 pt-2 pb-6 flex flex-col">
                        <div className="h-[96px] w-[96px] flex items-start justify-start">
                        <img
                         src={getDocVisual({ kind: "paraphraser" }).iconSrc}
                         alt=""
                         className="w-[96px] h-auto max-h-[96px] object-contain block select-none"
                         draggable={false}
                          />
                        </div>
                        <h3
                        ...
                        >
                          <span className="font-semibold text-slate-900">
                            {tr("library_prefix_paraphraser", "Parafraseoa:")}
                          </span>{" "}
                          <span className="font-normal text-slate-700">
                            {tr("library_template_paraphraser", "Plantilla")}
                          </span>
                        </h3>
                      </div>
                    </div>
                    ...
                    >
                      <div className="h-full w-full px-5 pt-8 pb-6 flex flex-col">
                        ...
                        >
                          <span className="font-semibold text-slate-900">
                            {tr("library_prefix_humanizer", "Humanizatua:")}
                          </span>{" "}
                          <span className="font-normal text-slate-700">
                            {tr("library_template_humanizer", "Plantilla")}
                          </span>
                        </h3>
                      </div>
                    </div>
