...
export default function Resumen() {
  ...
  const labelUrlsNoteVisible = tr("summary.urls_note_visible","Solo se puede resumir contenido visible sin login.");
  const labelUrlsNotePaywalled = tr("summary.urls_note_paywalled","El contenido con muro de pago no se podrá procesar.");
  ...
  const labelHelpRight = tr("summary.create_help_right","Selecciona una fuente (texto, documentos o URLs) y pulsa “Generar resumen”.");
            ...
            <div className="flex-1 overflow-hidden p-4">
              ...
              {sourceMode === "document" && (
                ...
                >
                  ...
                  />
                  <button
                    type="button" onClick={triggerPick}
                    ...
                    aria-label={labelChooseFileTitle} title={labelChooseFileTitle}
                  >
              ...
              {sourceMode === "url" && (
                <div className="h-full w-full flex flex-col">
                  <div className="mb-3 flex items-center justify-between">
                    ...
                    <button
                      type="button" onClick={() => setUrlInputOpen(true)}
                      ...
                      aria-label={labelAddUrl} title={labelAddUrl}
                    >
                  ...
                  {urlInputOpen && (
                    <div className="mb-4 rounded-xl border border-slate-300 p-3 bg-white">
                      ...
                      <div className="mt-2 flex items-center gap-2">
                        ...
                        <button
                          type="button" onClick={() => { setUrlsTextarea(""); setUrlInputOpen(false); }}
                      ...
                      <div className="mt-6 text-xs text-slate-500">
                        • {labelUrlsNoteVisible}<br />• {labelUrlsNotePaywalled}
                      </div>
                    </div>
                  )}
