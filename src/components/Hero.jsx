      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden w-full">
          ...
          <div className="h-12 flex items-center justify-between px-4 sm:px-6 border-b border-slate-200">
            ...
            {/* Botón swap dentro de un cuadrado suave */}
            <button
              type="button"
            ...
            {/* Dcha: selector tipo texto + caret */}
            <button
              type="button"
              className="inline-flex items-center gap-2 text-[15px] font-medium text-slate-700 hover:text-slate-900"
            >
          ...
          {/* Cuerpo: dos paneles como antes */}
          <div className="grid grid-cols-1 md:grid-cols-2 w-full min-h-[420px]">
